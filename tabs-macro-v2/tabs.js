Macro.add('tabs', {
    ...
    handler : function() {
      ...
      $contents.append(...this.context.contents);
  ...
  Macro.add('tab', {
    ...
    handler : function() {
      ...
      parent.context.contents.push($(`<div class="tabs-content hidden" id="${parent.context.prefix}${tabid}">`).wiki(this.payload[0].contents.trim()));
